<div id="header" class="header navbar navbar-default navbar-fixed-top">
    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            <a href="{{url('/index')}}" class="navbar-brand"><span class="navbar-logo"><i class="ion-ios-cloud"></i></span> <b>Color</b> Admin</a>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu media-list pull-right animated fadeInDown">
                    ...
                    <li class="media">
                        <a href="javascript:;">
                            <div class="media-left"><img src="admin/assets/img/user-1.jpg" class="media-object" alt="" /></div>
                            <div class="media-body">
                    ...
                    <li class="media">
                        <a href="javascript:;">
                            <div class="media-left"><img src="admin/assets/img/user-2.jpg" class="media-object" alt="" /></div>
                            <div class="media-body">
            ...
            <li class="dropdown navbar-user">
                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
							<span class="user-image online">
								<img src="admin/assets/img/user-13.jpg" alt="" />
							</span>
